...
const Item = (props) => {
  return (
    <>
        <div className="item flrx flex-col w-64 h-96  bg-gradient-to-tl from-white to-pink-200 p-2 rounded-xl hover:scale-105 transition-all duration-300 cursor-pointer">
