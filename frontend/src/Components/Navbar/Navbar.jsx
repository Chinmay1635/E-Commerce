  ...
  return (
    <nav className="navbar w-screen flex py-2 px-6 justify-between">
      <div className="nav-left flex items-center">
        ...
        <h3 className='text-xl'>SHOPPER</h3>
      </div>
      ...
      <div className="nav-right flex items-center gap-5">
        <button className='border-zinc-400 border-2 px-4 py-2 rounded-full active:bg-zinc-300'><Link to='/login'>Login</Link></button>
        <Link to='/cart'><img className='h-1/3 cursor-pointer' src={Cart} alt="" /></Link>
